...
const steps = [
  ...
  // {name: "Canceled", description :"by 16 Jul-18 Jul", value: "CANCELED"},
];
        ...
        <>
          <div key={index} className={`flex px-4`}>
            <div className="flex flex-col items-center">
              <Box
                sx={{ zIndex: -1 }}
                className={`w-8 h-8 rounded-full flex items-center justify-center z-10 ${index <= currentStep ? "bg-gray-200 text-[#00927c]" : "bg-gray-300 text-gray-600"}`}
              >
                {index <= currentStep ? (
                  <CheckCircleIcon />
                ) : (
            ...
            <div className={`ml-2 w-full`}>
              <div
                className={`${
                  step.value === orderStatus
                    ? "bg-[#00927c] p-2 text-white font-medium rounded-md -translate-y-3"
                    : ""
                }
              ...
              >
                ...
                <p
                  className={`
                    ${step.value === orderStatus ? "text-gray-200" : "text-gray-500"} text-xs
                    `}
                >
                  {step.description}
                </p>
