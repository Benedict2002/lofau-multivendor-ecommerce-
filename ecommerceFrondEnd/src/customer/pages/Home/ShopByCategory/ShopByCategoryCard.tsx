...
const ShopByCateoryCard = ({ item }: { item: HomeCategory }) => {
  return (
    <div className="flex gap-3 flex-col justify-center items-center group cursor-ponter">
...
export default ShopByCateoryCard;
