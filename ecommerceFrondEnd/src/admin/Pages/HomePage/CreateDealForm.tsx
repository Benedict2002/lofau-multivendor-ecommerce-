...
//   const dealCategories = (customer.homePageData?.category || []).map(
//     (deal) => deal.category,
//   );
...
const CreateDealForm = () => {
  ...
  // Correct source for categories
  const dealCategories = customer.homePageData?.dealCategories || [];

  console.log("Deal Categories:", dealCategories);
  console.log("FULL HOME DATA:", customer.homePageData);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      console.log("Submitting Deal:", reqData);
